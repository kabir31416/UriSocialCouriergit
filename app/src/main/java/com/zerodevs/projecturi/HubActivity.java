...
public class HubActivity extends BaseActivity {
    ...
    ImageView btnEditParcel, btnAssignRider, btnstatusup, btnGenerateLabel;

    Button btnUpdateLocation ;
    ImageView btnSearchParcel, btnCallSen, btnCallRec, btnScan, ivBack;
    TextView tvParcelInfo;

    TextView tvDetails, ParcelCn ;

    TextView recn, recm, reca, rect;

    TextView pstatus, pdate, pcod, pnote, pdc, pdes, ptype, ptrack;

    TextView rin, rim, sen, sem, sent, sena;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCallSen = findViewById(R.id.btnCallSen);
    ...
    private void showApprovedParcel(DocumentSnapshot doc) {
        ...
        StringBuilder tvpdes = new StringBuilder();
        StringBuilder tvsen = new StringBuilder();
        StringBuilder tvsem = new StringBuilder();
        StringBuilder tvsena = new StringBuilder();
        StringBuilder tvsent = new StringBuilder();
        ...
        StringBuilder tvptype = new StringBuilder();
        ...
        Cn.append("CN#").append(doc.getString("parcelId"));
        tvpnote.append(doc.getString("note"));
        tvpstatus.append(doc.getString("status"));
        tvpdes.append(doc.getString("description"));

        tvptype.append(doc.getString("parcelType"));
        ...
        tvsen.append(doc.getString("senderName"));
        tvsena.append(doc.getString("pickupAddress"));
        tvsem.append(doc.getString("senderPhone"));
        tvsent.append(doc.getString("pickupUpazila")).append(", ").append(doc.getString("pickupDistrict"));


        ParcelCn.setText(Cn.toString());
        pdc.setText(tvpdc.toString());
        ptype.setText(tvptype.toString());
        pstatus.setText(tvpstatus.toString());
        ...
        sen.setText(tvsen.toString());
        sem.setText(tvsem.toString());
        ...
        btnCallSen.setOnClickListener(v -> {
            String mobile = sem.getText().toString().trim();  // rim = riderMobile TextView
            if (!mobile.isEmpty()) {
        ...
        db.collection("Parcels").document(doc.getId()).collection("TrackingHistory")
                ...
                .get().addOnSuccessListener(snapshot -> {
                    ...
                    for (DocumentSnapshot historyDoc : snapshot) {
                        ...
                        String time = ts != null ? new SimpleDateFormat("dd MMMM, yyyy hh:mm a", Locale.getDefault()).format(ts.toDate()) : "Unknown";
